...
El comando `git reflog` muestra un historial de los movimientos que ha realizado HEAD en el repositorio. Permite ver commits, resets y otros cambios recientes, incluso cuando un commit ya no aparece en `git log`.
